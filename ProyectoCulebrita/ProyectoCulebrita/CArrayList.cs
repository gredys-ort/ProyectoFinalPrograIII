...
namespace ProyectoCulebrita
{
    internal class CArrayList
    {
        ...
        internal static Point MostrarComida(Size screenSize, ColaArrayList snake)
        {
        ...
        internal static bool MoverLaCulebrita(ColaArrayList snake, Point posiciónObjetivo, int longitudCulebra, Size screenSize)
        {
