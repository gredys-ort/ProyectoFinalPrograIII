...
namespace ProyectoCulebrita
{
    internal class Arreglo
    {
        ...
        internal static Point MostrarComida(Size screenSize, ColaArreglo snake)
        {
        ...
        internal static bool MoverLaCulebrita(ColaArreglo snake, Point posiciónObjetivo, int longitudCulebra, Size screenSize)
        {
